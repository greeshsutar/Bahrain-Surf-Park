    ...
    >
      ...
      <div className="relative z-20 max-w-7xl mx-auto w-full px-6 sm:px-12 pt-36 sm:pt-44 pb-24 flex flex-col justify-center text-left my-auto">
        <div className="max-w-3xl">
          <span className="visit-hero-anim text-[#00C8A0] text-xs sm:text-sm font-extrabold tracking-[0.28em] uppercase mb-4 block">
            PLAN YOUR VISIT
          </span>

          <h1 className="visit-hero-anim font-serif text-4xl sm:text-6xl lg:text-[72px] font-bold text-white tracking-tight leading-[1.01] mb-6 drop-shadow-lg">
          ...
          <div className="visit-hero-anim flex flex-wrap items-center gap-4 sm:gap-6">
            <button
              ...
              className="bg-[#00C8A0] hover:bg-[#00B590] text-[#02141C] font-extrabold px-9 py-4 rounded-xl text-xs uppercase tracking-widest transition-all shadow-xl hover:shadow-[#00C8A0]/40 cursor-pointer inline-flex items-center gap-2.5 hover:-translate-y-0.5"
            >
