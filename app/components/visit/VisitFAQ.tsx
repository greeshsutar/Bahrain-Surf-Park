...
export default function VisitFAQ() {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-12 text-left relative z-10">
        <div className="faq-row-anim mb-16 max-w-2xl">
          ...
          <h2 className="font-serif text-3xl sm:text-5xl lg:text-6xl font-bold text-white leading-[1.02] tracking-tight mb-4">
            ARRIVING AT<br />THE LAGOON.
          </h2>
        ...
        {/* Single Column Thin Rules FAQ (No boxes, no cards, no shadows) */}
            ...
            return (
              <div key={idx} className="faq-row-anim py-6 sm:py-8 group">
                <button
                  ...
                  className="w-full flex items-center justify-between text-left focus:outline-none cursor-pointer py-2 group-hover:text-[#00C8A0] transition-colors"
                >
                  ...
                  <span className="w-8 h-8 rounded-full bg-white/5 border border-white/20 flex items-center justify-center text-[#00C8A0] text-xl font-light shrink-0 transition-transform duration-300 group-hover:border-[#00C8A0]">
                    <span className={`transform transition-transform duration-300 ${isOpen ? "rotate-45 text-[#00C8A0]" : "rotate-0 text-white"}`}>
                      +
                    </span>
                  </span>
                </button>
                ...
                >
                  <div className="overflow-hidden">
                    <p className="text-sm sm:text-base text-slate-300 leading-relaxed font-sans max-w-3xl pr-6">
                      {faq.a}
                    </p>
                  </div>
                </div>
