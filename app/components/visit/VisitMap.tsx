...
export default function VisitMap() {
  ...
  return (
    <section
      ref={sectionRef}
      id="wayfinding-map"
      className="relative bg-gradient-to-b from-[#061C27] via-[#02141C] to-[#0A1926] text-white pt-20 sm:pt-28 pb-0 z-10 overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        <div className="text-left mb-10 visit-map-anim max-w-2xl">
        ...
        {/* Substantial Map Visual Component with Parallax Scrub */}
        <div
          ref={mapParallaxRef}
        ...
        >
          ...
          {/* Map Embed Window (55vh - 65vh height range) */}
          <div className="w-full h-[50vh] sm:h-[58vh] lg:h-[65vh] relative">
            <iframe
      ...
      {/* Wave Divider Transitioning into Visitor Essentials (#F7F6F1) */}
