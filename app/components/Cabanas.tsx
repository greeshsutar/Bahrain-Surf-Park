...
export default function Cabanas() {
  ...
  return (
    <section
      ref={sectionRef}
      id="cabanas"
      className="bg-white py-14 sm:py-20 relative z-10 overflow-hidden border-t border-slate-100"
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 text-left flex flex-col justify-center">
            ...
            <h2 className="cabanas-animate font-serif text-3xl sm:text-4xl lg:text-[2.75rem] font-bold text-[#0A1926] leading-[1.18] tracking-tight mb-6">
            ...
            <div className="cabanas-animate flex">
              <a
                ...
                className="bg-[#0B7FB5] hover:bg-[#0077B6] text-white px-8 py-3.5 rounded-lg text-xs font-bold uppercase tracking-wider transition-all inline-flex items-center gap-2 cursor-pointer shadow-md"
              >
          ...
          <div className="lg:col-span-7 relative flex items-center justify-center gap-6">
            ...
            <div className="cabanas-animate w-1/2 aspect-[3/4] rounded-xl overflow-hidden shadow-lg border border-slate-100 bg-[#F1F5F9] relative flex flex-col justify-center items-center text-center p-4">
            ...
            <div className="cabanas-animate w-1/2 aspect-[3/4] rounded-xl overflow-hidden shadow-lg border border-slate-100 bg-[#F1F5F9] relative flex flex-col justify-center items-center text-center p-4 mt-12">
              <div className="absolute inset-0 bg-slate-900/5 z-10 pointer-events-none"></div>
              <svg className="w-12 h-12 text-[#0B7FB5]/30 mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
